        ...
        <form className={styles['LoginPageForm']}>
          ...
          <button type="button" className={styles['LoginPageButton']}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_361_3005)">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M10 20.0004C12.7 20.0004 14.9637 19.1049 16.6182 17.5777L13.3864 15.0686C12.4909 15.6686 11.3455 16.0231 10 16.0231C7.39548 16.0231 5.19093 14.264 4.40457 11.9004H1.06366V14.4913C2.70911 17.7595 6.09093 20.0004 10 20.0004Z" fill="#34A853"/>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M10 3.97727C11.4682 3.97727 12.7864 4.48182 13.8227 5.47273L16.6909 2.60455C14.9591 0.990909 12.6955 0 10 0C6.09093 0 2.70911 2.24091 1.06366 5.50909L4.40457 8.1C5.19093 5.73636 7.39548 3.97727 10 3.97727Z" fill="#EA4335"/>
              </g>
              <defs>
            ...
            <div className={styles['LoginPageFormGroup']}>
              ...
              <button type="button" className={styles['LoginPageReveal']}>
                <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13.2177 4.2463C13.3835 4.45302 13.4753 4.72159 13.4753 5.00006C13.4753 5.27853 13.3835 5.5471 13.2177 5.75382C12.1677 7.02509 9.77764 9.5001 6.98764 9.5001C4.19764 9.5001 1.80764 7.02509 0.757639 5.75382C0.591799 5.5471 0.5 5.27853 0.5 5.00006C0.5 4.72159 0.591799 4.45302 0.757639 4.2463C1.80764 2.97503 4.19764 0.5 6.98764 0.5C9.77764 0.5 12.1677 2.97503 13.2177 4.2463Z" stroke="#7C7C7C" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M6.98767 7C8.09224 7 8.98767 6.10457 8.98767 5C8.98767 3.89543 8.09224 3 6.98767 3C5.8831 3 4.98767 3.89543 4.98767 5C4.98767 6.10457 5.8831 7 6.98767 7Z" stroke="#7C7C7C" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </button>
            </div>
          </div>
          ...
          <p className={styles['LoginPageRegister']}>
            New to TKT? <a href="/register">Create account</a>
          </p>
        </form>
